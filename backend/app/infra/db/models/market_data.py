...
from sqlalchemy import DECIMAL, BigInteger, Date, String, UniqueConstraint, func
...
class MarketData(Base):
    ...
    def __repr__(self) -> str:
        return (
            f"<MarketData(id={self.id}, ticker={self.ticker}, "
            f"market={self.market}, date={self.date}, close={self.close})>"
        )
