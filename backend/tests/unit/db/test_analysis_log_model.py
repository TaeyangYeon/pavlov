...
def test_market_enum_values():
    ...
    analysis_log_invalid = AnalysisLog(
        date=date(2024, 1, 1),
...
def test_ai_response_json_nullable():
    ...
    # Test nullable
    analysis_log_no_response = AnalysisLog(
        date=date(2024, 1, 1),
        market="US"
    )
...
def test_error_message_nullable():
    ...
    # Test nullable
    analysis_log_no_error = AnalysisLog(
        date=date(2024, 1, 1),
        market="US"
    )
